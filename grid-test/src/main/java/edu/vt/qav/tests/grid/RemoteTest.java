...
public class RemoteTest {
	...
	protected String TEST_CLASS = this.getClass().getCanonicalName();
	...
	@BeforeSuite
	@Parameters ({ "hub", "oslist" }) //defined in resources/testng.xml
	public void setUp(String hub, String oslist) throws Exception {
		...
		System.out.println("RemoteTest::setUp(): " + webDriverList.size() +" clients.");
	}
	...
	public void tearDown() throws Exception {
		...
		System.out.println("RemoteTest::tearDown() of " + webDriverList.size() + " clients.");
   ...
   public static Iterator<Object[]> webdrivers() {
	  System.out.println("RemoteTest:webdrivers(): " + webDriverList.size() +" clients.");
